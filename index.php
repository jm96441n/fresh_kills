...
<body>
	<div class="container-full">
		<div class="row home">
			<div id="logo_container" class="col-lg-8 col-md-8 col-sm-12 col-lg-offset-2 col-md-offset-2">
				<img id="logo" alt="main_logo" src="./main_logo.png" />
			</div>
		</div>
		<div class="row">
			<div id="menu_container" class="col-lg-8 col-md-8 col-sm-12 col-lg-offset-2 col-md-offset-2">
				<div>
					<div class="gold_logo_container">
						<img class="gold_logo" alt="gold_logo" src="./main_gold_logo.png"/>
					</div>
					<div class="section_header">
						...
						<p><span class="wine_type">RED:</span> $8/$11 </p>
						<p><span class="wine_type">WHITE:</span>  $8/$11 </p>
						<p><span class="wine_type">ROSÉ:</span>  $8 </p>
						...
						<p>BEEF JERKY <span><img src="./dot.png" alt="dot" id="dot" ></span>  MIXED NUTS</p>
		...
		<div class='row'  id="gallery_container">
			<div class="col-lg-2 col-md-2 hidden-sm hidden-xs side_logo">
				<img class="side_img" alt="left_side" src="./left_side.png" >
			</div>
			<div class="col-lg-8 col-md-8 col-sm-12">
				<div>
					...
					<div class="row" id="bar_top">
						<img class="bar_top col-md-12 col-lg-12 hidden-sm hidden-xs" alt="bar_top" src="./bar_top.png"/>
					</div>
					...
					<div class='fotorama photo-div'
							 ...
							 data-loop="true"
						>
						<img alt="bar_1" src="./img/bar/Bar_1.jpg" >
						<img alt="bar_2" src="./img/bar/Bar_2.jpg" >
					</div>
					...
					<div class="fotorama photo-div"
							 ...
							 data-loop="true"
						>
						<img alt="drink_1" src='./img/cocktails/Drink_03.jpg' >
						<img alt="drink_2" src='./img/cocktails/Drink_05.jpg' >
						<img alt="drink_3" src='./img/cocktails/Drink_07.jpg' >
						<img alt="drink_4" src='./img/cocktails/Drink_09.jpg' >
						
						<img alt="drink_5" src='./img/cocktails/Drink_13.jpg'>
						<img alt="drink_6" src='./img/cocktails/Drink_14.jpg'>
						<img alt="drink_7" src='./img/cocktails/Drink_16.jpg'>
					</div>
					...
					<div class='fotorama photo-div'
							 ...
							 data-loop="true"
						>
						<img alt="ice_1" src="./img/ice/Ice_01.jpg" >
						<img alt="ice_2" src="./img/ice/Ice_03.jpg" >
					</div>
					...
					<div class='row'>
						<a href="https://www.instagram.com/freshkillsbar/" class="col-lg-2 col-md-2 col-sm-2 col-lg-offset-5 col-md-offset-5 col-sm-offset-5" >
							<img src='./instagram.jpg' alt='insta_logo' id='insta_logo'>
						</a>
					</div>
				</div>
			</div>
			<div class="col-lg-2 col-md-2 hidden-sm hidden-xs side_logo">
				<img class="side_img" alt="right_side" src="./right_side.png" >
			</div>
		</div>
		<div class="row" id="contact_container">
			<div class="col-lg-6 col-md-6 col-sm-12 col-lg-offset-3 col-md-offset-3">
					<img class="secondary_logo" alt="secondary_logo" src="./secondary_logo.png"/> 
					<a href="https://www.google.com/maps/place/Fresh+Kills+Bar/@40.7147805,-73.9637076,17z/data=!3m1!4b1!4m5!3m4!1s0x89c2596059a773ef:0xdb075cac1a1aecaa!8m2!3d40.7147805!4d-73.9615189"  target="_blank">	
						<div class="map_logo">
							...
							<img alt="map_logo" src="./map_logo.png"/>
						</div>
					</a>
	...
	<nav class="nav_black">
		<p id="links_p">
			<a class="nav_items_black" id="home"  href="#">HOME</a> 
			<a class="nav_items_black" id="menu" href="#">THE MENU</a> 
			<a class="nav_items_black" id="gallery" href="#">PICTURES</a>  
			<a class="nav_items_black" id="contact" href="#">CONTACT</a>
		</p>
	</nav>
